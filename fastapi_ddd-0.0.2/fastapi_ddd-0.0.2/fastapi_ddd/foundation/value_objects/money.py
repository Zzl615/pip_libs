...
from fastapi_ddd.foundation.value_objects.currency import Currency
...
class Money:
    def __init__(self, currency: Type[Currency], amount: Any) -> None:
        ...
        try:
            ...
            if decimal_tuple.sign:
                ...
                raise ValueError(f"given amount has invalid precision! It should have "
    ...
    def __str__(self) -> str:
        return f"{self._currency.symbol} {self._amount} "
